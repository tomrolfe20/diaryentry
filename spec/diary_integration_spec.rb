...
it 'return an instance of diary entry representingg the entry that is closest to ut not over the length the user could read in the minutes they have available' do
    diary = Diary.new
